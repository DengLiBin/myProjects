...
*/
        for(int i=0;i<100;i++){
            AppInfo info=new AppInfo(123123+i,"微信"+i,"com.youyuan.yyhl","app/com.youyuan.yyhl/icon.jpg",4,3876203+i,"app/com.youyuan.yyhl/com.youyuan.yyhl.apk","产品介绍：微信是时下最受大众单身男女青睐的聊天交友软件");
            appInfos.add(info);
        }
